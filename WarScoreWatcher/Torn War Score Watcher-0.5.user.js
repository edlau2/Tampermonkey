...
(function() {
    ...
    function checkCurrentScore() {
        ...
        switch (notifyValue.toLowerCase()) {
            case 'ourscore':
                if (doLog() == true)
                    log("ourScore: ", ourScore, " notify: ", notifyScore, " ourScore >= notifyScore? ", (ourScore >= notifyScore));
            ...
            case 'theirscore':
                if (doLog() == true)
                    log("theirScore: ", theirScore, " notify: ", notifyScore, " theirScore >= notifyScore? ", (theirScore >= notifyScore));
            ...
            case 'lead':
                if (doLog() == true)
                    log("lead: ", lead, " notify: ", notifyScore, " lead >= notifyScore? ", (lead >= notifyScore));
                if (lead >= notifyScore) {
                    msg = "You've hit " + notifyScore + "!";
                    notify = true;
                }
            ...
            case 'remains':
                if (doLog() == true)
                    log("remains: ", remains, " notify: ", notifyScore, " remains <= notifyScore? ", (remains <= notifyScore));
