...
(function() {
    ...
    // wildcard removr class
    function removeClassStartingWith(node, begin) {
        log("removing class starts: ", begin, " node: ", $(node));
    ...
    function addColorClass(tcell, respType, type) {
        log("Adding color class, type: ", type);
        if (respType == "Congratulatory") $(tcell).addClass("xcellC" + type); //.removeClass("xcellD" + type).removeClass("xcellR" + type);
        if (respType == "Professional") $(tcell).addClass("xcellC" + type); //.removeClass("xcellD" + type).removeClass("xcellR" + type);

        if (respType == "Considerate") $(tcell).addClass("xcellD" + type); //.removeClass("xcellC" + type).removeClass("xcellR" + type);
        if (respType == "Terse") $(tcell).addClass("xcellD" + type); //.removeClass("xcellC" + type).removeClass("xcellR" + type);

        if (respType == "Realistic") $(tcell).addClass("xcellR" + type); //.removeClass("xcellD" + type).removeClass("xcellD" + type);
        if (respType == "Reassuring") $(tcell).addClass("xcellR" + type); //.removeClass("xcellC" + type).removeClass("xcellD" + type);
    }
