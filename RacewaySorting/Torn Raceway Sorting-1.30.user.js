...
(function() {
    ...
    function setBestCarSelection(retries=0) {
        ...
        let carParts = suggested.split('-');
        let carName = carParts[0].trim();
    ...
    // https://www.torn.com/loader.php?sid=racing&tab=customrace&rfcv=685ded0389ff6
    ...
    function reloadCustomRaces() {
        ...
        $.get(
            ...
            function (data, status) {
                let newPage = $(data);
                let eventsList = $(newPage).find(".events-list");
