...
(function() {
    ...
    function handleCaretClick(e) {
        ...
        let closing = $("#xtrav-cs").hasClass("fa-caret-down"); // will be moving it to right, open now...
        $("#xtrav-cs").toggleClass("fa-caret-down fa-caret-right");

        //let newH = closing ? "0px" : maxHeight;
        if (!closing) {
            if (!savedUl) {
                console.error("ERROR: no saved UL!!!");
                debugger;
            }
    ...
    function handlePageLoad(retries=0) {
        ...
        if (atTravelAgency()) {
            ...
            debug("*** destinationLinks: ", destinationLinks);
