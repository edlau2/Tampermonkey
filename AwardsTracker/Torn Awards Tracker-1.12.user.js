...
(function() {
    ...
    */
    ...
    const testArr = [pips0, pips1, pips2, pips3, pips4, pips5, pips6, pips7, pips8, pips9, pips10];
    ...
    function getAvailMerits() {
        ...
        //GM_setValue("availMerits", JSON.stringify(availMerits));
    }
    ...
    function handleMeritRowClick(e) {
        ...
        // Wait for the dialog to appear, to either clone,
        // or move from the hidden panel.
        ...
        function handleBtnTriggered(btn, txt, retries=0) {
            ...
            log("Not Close or Cancel btn: ", txt, $(btn).text(), $(btn));
        }
