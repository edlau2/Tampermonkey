...
(function() {
    ...
    const quickItemDiv =
            `<div id="xedx-i372" class="item" draggable="true" data-id="372" title="Empty Box + SED" data-category="Special">
                <div class="pic" style="background-image: url(/images/items/372/medium.png)"></div>
                <div class="text" data-qty="">Empty Box</div>
    ...
    function addDevDashboard() {
        if ($("#quickItems").length > 0) {
            ...
            if (displayAsQuickItem == true) {
                $("#quickItems > main > div.inner-content").append(quickItemDiv);
            } else {
    ...
    function handlePageLoad() {
        if (onMakeParcelPage() == true) {
            ...
            if (hasQuickItems == true && displayAsQuickItem == true) {
                ...
                $("#xqi-remove").on('click.xedx', function(e) {
                    $("#xedx-i372").remove();
