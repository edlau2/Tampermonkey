    ...
    function getStatsDiv() {
        let statsDiv = `<div id="xedx-jail-stats"  class="xoptwrap flexwrap title-black xnb bottom-round">
                             <span style="width: 100%;">
                                 <span id="daily-busts" class="">Today's busts: 0</span>
                                 <span id="max-busts" class="xml10">Most daily: 0</span>
                                 <span id="min-p0" class="">Minimum Penalty: 0.0</span>
                                 <span id="max-p0" class="xml10">Maximun Penalty daily: 0</span>
                                 <span id="hi-score" class="xml10">Highest score:: 0</span>
                             </span>

                             <span class="break"></span>

                             <span style="width: 75%; margin-bottom: 30px;">
                                 <span id="ppl-busted" class="">Total Busts: 0</span>
                                 <span id="busts-needed" class="xml10"></span>
                                 <span id="fail-busts" class="xml10">Failed Busts: 0</span>
                             </span>
                             <span class="xopt-span">
                                 <input id="xedx-stats-btn" type="submit" class="xedx-torn-btn xmt5 xmr10" value="Stats">
                             </span>
