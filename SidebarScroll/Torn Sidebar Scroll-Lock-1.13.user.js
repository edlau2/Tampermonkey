...
/*  This script lets the sidebar scroll independently of the center content
    ...
    Awards count is just stuck over on the sidebar here until I find a better script to add from
*/
...
(function() {
    ...
    function handlePageLoad(retries=0) {
        ...
        if (hdrHidden == true) {
            $("#topHeaderBanner").slideToggle("slow", function() { setTop0(); });
        ...
        function setTop0() {
            if ($("#topHeaderBanner").hasClass("xt0"))
                $("#topHeaderBanner").removeClass("xt0");
            else
                $("#topHeaderBanner").addClass("xt0");
        }
        ...
        function handleHide(e) {
            $("#topHeaderBanner").slideToggle("slow", function() {
                $("#sidebarroot").toggleClass("xt0");
                //setTop0();
            });
    ...
    function queryStatsCB(responseText, ID, node) {
        ...
        $("div[class*='points__']").append(awardsSpan);
