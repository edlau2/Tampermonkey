...
(function() {
    ...
    function handleOutsideClicks() {
        $("html").click(function (e) {
            ...
            let divW = $(div).width();
            let divH = $(div).height();
            let xIn = (e.clientX > pos.left && e.clientX < (pos.left + divW));
            let yIn = (e.clientY > pos.top && e.clientY < (pos.top + divH));
            debug("Outside event click? L: ", pos.left, " r: ", (pos.left + divW), " t: ", pos.top,
                " b: ", (pos.top + divH), " cx: ", e.clientX, " cy: ", e.clientY);
            if (xIn && yIn) {
                debug("Inside width and height.");
                return;
            }
            if (e.target != div) {
                debug("preview removing window!");
                $("#xedx-preview").remove();
            }
        });
    }
