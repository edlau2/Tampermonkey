...
(async function() {
    ...
    function openNow(slide) {
        log("[openNow] ", $("#xoptsWrap").hasClass('xclosed'), slide, btnIndex());
        if ($("#xoptsWrap").hasClass('xclosed')) {
            $("#xoptsWrap").toggleClass("xclosed xopen");
            ...
            //$("#opts-btn > i").addClass("fa-caret-down").removeClass("fa-caret-right");
            $("#xoptsWrap").css("display", "flex");
            //$("#xoptsWrap").toggleClass("xclosed xopen");
    ...
    function closeNow(slide) {
        log("[closeNow] ", $("#xoptsWrap").hasClass('xopen'), slide, btnIndex());
        ...
        if ($("#xoptsWrap").hasClass('xopen')) {
            ...
            //$("#opts-btn > i").addClass("fa-caret-right").removeClass("fa-caret-down");
