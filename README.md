...
This script add rank next to the level in the User List, as seen when searching for users. The goal was to make it easier to more quickly decide what targets for an attack, without having to inspect the user individually. Of course, you may want to still look at things such as Xanax or SE's used, that is up to you.
