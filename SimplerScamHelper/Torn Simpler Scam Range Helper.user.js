...
(function() {
    ...
    var redTideCheck = GM_getValue("redTideCheck", true);                     // If predicted range has red - warn on commit click.
    ...
    function handleCommit(e) {
        ...
        let dontWarn = (lastIdx > 2 || title == "Read" || capitalizeActive);
