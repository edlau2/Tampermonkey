...
// ****************************************************************************************
//                TBD: Finishing adding catch block around all promises!
//                     See: function tornCustomizableSidebar()
// ****************************************************************************************
...
(function() {
    ...
    function tornLatestAttacksExtender() {
        ...
        function extendLatestAttacks() {
            ...
            if (isActive) {
                ...
                //log("adding class 'active': ", $("#xedx-mattacks-ext"));
                //log("set to block: ", $(sel));
            } else {
                $("#xedx-mattacks-ext").removeClass("active");
                $(sel).attr("style", "display: none;");
                //log("removing class 'active': ", $("#xedx-mattacks-ext"));
                //log("set to none: ", $(sel));
            }
    ...
    function tornStatTracker() {
        ...
        function buildStatsUI(update=false) {
            ...
            for (let i=0; i < keys.length; i++) {
                let statName = keys[i];
                log("tornStatTracker: ", statName, " enabled: ", optStats[statName].enabled);
                if (optStats[statName].enabled) {
                    log("tornStatTracker add or update: ", update);
                    if (update) {
        ...
        function massageStat(statName) {
            log("tornStatTracker massageStat: ", statName, ": ", personalStats[statName]);
    ...
    function initOptStats() {
        ...
        addOptStat("traveltime", "Total Travel Time", "travel", "365:00:00"); //"31,536,000");
    ...
    function tornJailStats() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (isActive) {
                ...
                $(sel).attr("style", "display: block;");
                //log("adding class 'active': ", $(jailExtDivSel));
                //log("set to block: ", $(sel));
            } else {
                $(jailExtDivSel).removeClass("active");
                $(sel).attr("style", "display: none;");
                //log("removing class 'active': ", $(jailExtDivSel));
                //log("set to none: ", $(sel));
            }
    ...
    function tornHideShowChat(param) {
        //log('[tornHideShowChat] param: ', param);
        ...
        return new Promise((resolve, reject) => {
            ...
            //log("tornHideShowChat calling appendHideShowChatDiv");
            ...
            //log("tornHideShowChat Length: ", $('#showHideChat').length);
            ...
            //log("tornHideShowChat almost done: ", $('#showHideChat'));
        ...
        function getHideChatDiv() {
            //log("tornHideShowChat -> getHideChatDiv");
        ...
        function appendHideShowChatDiv() {
            ...
            if ($('#showHideChat').length) {
                ...
                //log("hideshowchat installed: ", $('#showHideChat'));
                return true;
            } else {
    ...
    function tornStockProfits() {
        ...
        function modifyPage() {
            ...
            let mainStocksUL = $("#stockmarketroot").find('[class^="stockMarket"]')[0];
            if (!mainStocksUL) {
            ...
            if (stocksList.length < 2) {
                log("Retrying stocks page, no stocks yet...");
                return setTimeout(modifyPage, 250); // Check should not be needed
            }
    ...
    */
    ...
    // ================================================================================
    //
    // Extra stuff I just needed to put somewhere....
    //
