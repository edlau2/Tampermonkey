...
(function() {
    ...
    function tornStockProfits() {
        ...
        function clickClaimBtn(target, retries=0) {
            log("[tornStockProfits] Waiting for claim button: ", retries);
        ...
        function toggleReadyOnly(e) {
            ...
            log("[tornStockProfits] readyStocksOnly: ", readyStocksOnly);
            callOnContentComplete(handleReadyStocks);
        }

        function handleReadyStocks() {
            log("[tornStockProfits] handleReadyStocks");
            ...
            log("[tornStockProfits] toggleReadyOnly: ", (readyStocksOnly ? "hiding" : "unhiding"), " elements");
