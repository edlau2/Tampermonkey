...
(function() {
    ...
    function tornStatTracker() {
        ...
        function addStat(statName, desc, val, required=null) {
            ...
            if (statVal == undefined || statVal == 'undefined') statVal = 0;
    ...
    function fixupOldOpts() {
        let tmp = GM_getValue('dbgopts-logging', null);
        if (tmp != null) {
            GM_setValue('loggingEnabled', tmp);
            GM_deleteValue('dbgopts-logging');
        }
        tmp = GM_getValue('dbgopts-dbglogging', null);
        if (tmp != null) {
            GM_setValue('debugLoggingEnabled', tmp);
            GM_deleteValue('dbgopts-dbglogging');
        }
        tmp = GM_getValue("dbgopts-alertonerror", false);
        if (tmp != null) {
            GM_setValue('alertOnError', tmp);
            GM_deleteValue('dbgopts-alertonerror');
        }
    }
    ...
    function initDebugOptions() {
        ...
        alertOnError = GM_getValue("alertOnError", false);
        ...
        GM_getValue("alertOnError", alertOnError);
    ...
    function handleGeneralConfigPage() {
        ...
        function addDebugMenu() {
            debug('[addDebugMenu]');
            let dbgOpts = [
                    { id: "loggingEnables", type: "cb", def: true, desc: "Enable Logging" },
                    { id: "debugLoggingEnabled", type: "cb", def: false, desc: "Enable Debug Only Logging" },
                    { id: "alertOnError", type: "cb", def: false, desc: "Alert on API errors" },
