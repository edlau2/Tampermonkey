// ==UserScript==
// @name         Torn Adv Mini Profile Lite
...
(function() {
    ...
    // Helpers
    function observeOn() {if (observer) {observer.observe(target, config);}}
    function observeOff() {if (observer) observer.disconnect();}
    ...
    */
    ...
    function getBestBatStatEstValues() {
        ...
        // No spy: return basic estimate
        if (!jsonSpy.estimate)
            return batStats.estimate;
        else
