...
// @xrequire      https://raw.githubusercontent.com/edlau2/Tampermonkey/master/helpers/Torn-JS-Helpers.js
...
(function() {
    ...
    function timerProc() {
        ...
        */
        ...
        $($("#xedx-chain-span")[0]).text(chainTime()); //.textContent = targetNode.textContent + ' | ' + chainNode.textContent.split('/')[0];
    };
