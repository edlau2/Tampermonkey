  ...
  "use strict";
    ...
    function startRefreshCb(responseText, ID, param) {
        ...
        try {
            ...
            console.error("[wall-battlestats2][startRefreshCb] JSON error: ", err);
            debug("[wall-battlestats2][startRefreshCb]Response: ", responseText);
            return;
        }

        if (!jsonObj) {
            log("[startRefreshCb] Error: no data! ", responseText);
            return;
        }
