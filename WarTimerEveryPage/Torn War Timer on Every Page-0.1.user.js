...
(function() {
    ...
    */
    ...
    // Handle page changes (not reloads)
    ...
    */
    ...
    function getWarTimerDiv() {
        const warTimerDiv = `
            <div id="x-war-watch" class="x-war-wrap x-drag xbgb">
                <div id="x-war-watchheader">
                    <div class="x-war-hdr title-black hospital-dark top-round">
