...
(function() {
    ...
    */
    ...
    GM_addStyle(`.xbc {border: 1px solid red;}
                 .xmed {border: 1px solid green;}
                 .bbetter {border: 2px solid blue !important;}
                 .bbest {border: 2px solid blue !important;
                         outline: 1px solid #ffff00a8;
                         outline-offset: -4px;}`);

    const specialTargets = {
        'lake': {text: "Net, Diesel", class: "xmed" },
        'foundry': {text: "Zip Ties, Magnesium Shavings, Fire Extinguisher", class: "bbetter" },
        "brewery": {text: "Fire Extinguisher", class: "bbetter" },
        'fertilizer': {text: "Zip Ties, Hand Drill, Fire Extinguisher", class: "bbetter" },
        'cottage': {text: "Lockpicks, Zip Ties", class: "xmed" },
        'beach': {text: "Net", class: "bbetter" },
        'mobile': {text: "Dog Treats, Hand Drill, Blowtorch", class: "bbest" },
        'suburban': {text: "Dog Treats, Hand Drill", class: "xmed" },
        'scout': {text: "", class: "xbc" },
        'tool': {text: "Lockpicks, Hand Drill, Blowtorch", class: "bbest" },
        'cabin': {text: "Lockpicks", class: "xbc" },
        'cleaning': {text: "Lockpicks", class: "xbc" },
        'farm': {text: "Hand Drill, C4, Blowtorch, Methane", class: "bbest" },
        'truckyard': {text: "Dog Treats, Diesel", class: "xmed" },
        'funeral': {text: "Scalpel", class: "xmbc" },
        'dentist': {text: "Scalpel, Hand Drill", class: "xmed" },
        'printing': {text: "Scalpel, Bonded Latex, Gasoline, Embosser", class: "bbest" },
        'paper': {text: "Fire Extinguisher", class: "bbetter" },
        'storage': {text: "Card Programmer, C4", class: "xmed" },
        'post': {text: "Card Programmer", class: "xmed" },
        'facility': {text: "", class: "xbc" },
        'market': {text: "Card Programmer, Lockpicks, Bonded Latex", class: "bbetter" },
        'ship': {text: "Hand Drill, C4, Thermite, Fire Extinguisher", class: "bbetter" },
        'factory': {text: "C4, Hydrogen, Fire Extinguisher", class: "bbetter" },
        'dock': {text: "Kerosene", class: "xmed" },
    };
    ...
    function customizeCrimeNodes() {
        ...
        for (let idx=0; idx < $(list).length; idx++) {
            ...
            if (special && special.text && special.text.length > 0) {
                let newText = "(" + special.text +")";
                ...
                if (special.class)
                    $(element).addClass(special.class);
