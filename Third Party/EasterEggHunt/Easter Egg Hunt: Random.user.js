...
const linksarray = ["index.php","item.php","city.php","jobs.php","gym.php","properties.php","education.php",
                    ...
                    "profiles.php?XID=","forums.php","personalstats.php","stockexchange.php?step=portfolio"];

const travellinksarray = ["index.php","newspaper.php","messages.php","events.php","stockexchange.php","profiles.php?XID=",
                           "usersonline.php","bringafriend.php","staff.php","friendlist.php","blacklist.php",
...
if (url.includes("laptop.php") || url.includes("forums.php")) {
    if (document.querySelector('.travelling')) {
...
function insertNormal() {
    ...
    let name = 'Easter Egg Hunt';
    let search = document.getElementsByClassName("1d8bf-popup-link")[0];
    if (search != 'undefined' && search != null) {name = "Egg On Page!!!";}
    ...
    randomLink.setAttribute('class', 'area-desktop___2YU-q undefined');
    randomLink.setAttribute('style', 'margin-bottom: 10px;');
    randomLink.id = "easterrandom";
    randomLinkInner.setAttribute('class', 'area-row___34mEZ');

    var href = document.createElement('a');
    href.setAttribute('class', 'desktopLink___2dcWC');
