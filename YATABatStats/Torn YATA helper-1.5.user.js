...
(function() {
    ...
    // get from prompt and storage
    const yata_api_key = GM_getValue("yata_api_key", "");
    ...
    function handlePageLoad(retries=0) {
        ...
        debug("Looking for login request: ", $("#yata-login-key"));
        if ($("#yata-login-key").length > 0) {
            $("#yata-login-key").val(yata_api_key);
            $("#yata-login-submit").click();
        }
